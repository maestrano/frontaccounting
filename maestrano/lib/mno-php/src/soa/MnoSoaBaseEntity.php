...
{                   
    ...
    */
	...
	$this->_mno_response_id = $mno_response_id = $response->id;
        ...
        $this->post_send_hook($mno_response_id);
    ...
    protected function post_send_hook($mno_response_id) {
        // DO NOTHING OR OVERRIDE IN ENTITY CLASS
    }
    ...
    protected function dbQueryReturnLastInsertedID($query) {
        global $db_last_inserted_id;
        
        $tmp_db_last_inserted_id = $db_last_inserted_id;
        $result = db_query($query);
        $int_db_id = $db_last_inserted_id;
        $db_last_inserted_id = $tmp_db_last_inserted_id;
