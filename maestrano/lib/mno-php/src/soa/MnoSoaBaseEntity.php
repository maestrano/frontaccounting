...
{                   
    ...
    */
    ...
    public function sendDeleteNotification($local_id) {
        ...
        $mno_id =  $this->getMnoIdByLocalId($local_id, $this->_local_entity_name, $this->_mno_entity_name);
    ...
    {            
      ...
      $this->_log->debug(__FUNCTION__ . " path = " . $url . $entity);
    ...
    */
    protected function getMnoIdByLocalId($localId, $localEntityName, $mnoEntityName)
    {
        return $this->_mno_soa_db_interface->getMnoIdByLocalIdName($localId, $localEntityName, $mnoEntityName);
    }
    ...
    * 	     	object->entity  	entity name related to ID
    */
    protected function getLocalIdByMnoId($mnoId, $mnoEntityName, $localEntityName)
    {
        return $this->_mno_soa_db_interface->getLocalIdByMnoIdName($mnoId, $mnoEntityName, $localEntityName);
    }
    
    public function getLocalIdsByMnoIdName($mnoId, $mnoEntityName)
    {
        return $this->_mno_soa_db_interface->getLocalIdsByMnoIdName($mnoId, $mnoEntityName);
    }
