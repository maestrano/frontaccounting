...
CREATE TABLE `0_users` (
  ...
  `theme` varchar(20) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'dynamic',
...
(1, 'admin', '5f4dcc3b5aa765d61d8327deb882cf99', 'Administrator', 2, '', 'adm@adm.com', 'ar_EG', 1, 0, 0, 0, 'dynamic', 'Letter', 2, 2, 4, 1, 1, 0, 1, '2012-09-04 16:37:28', 10, 1, 1, '', 1, 0, 'GL', 0);
